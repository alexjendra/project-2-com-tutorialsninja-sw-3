...
public class MyAccountsTest extends Utility {
    ...
    public void VerifyThatUserRegisterAccountSuccessfully() {
        ...
        sendTextToElement(By.id("input-firstname"), "Khushbu");
        sendTextToElement(By.id("input-lastname"), "Raval");
        sendTextToElement(By.id("input-email"), "Kishan@gmail.com");
        sendTextToElement(By.id("input-telephone"), "07844854418");
