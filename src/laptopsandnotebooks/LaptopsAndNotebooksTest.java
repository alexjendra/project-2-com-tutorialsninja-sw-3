...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() {
        ...
        sendTextToElement(By.id("input-payment-firstname"), "Aarohi");
        sendTextToElement(By.id("input-payment-lastname"), "Rana");
        sendTextToElement(By.id("input-payment-email"), "aaru@gmail.com");
        ...
        sendTextToElement(By.id("input-payment-postcode"), "EC1 223");
